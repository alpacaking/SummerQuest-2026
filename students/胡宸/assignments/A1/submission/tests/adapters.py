...
def run_transformer_block(
    ...
    """
    return transformer_block(in_features, num_heads, max_seq_len, theta, weights)
...
def run_transformer_lm(
    ...
    """
    return transformer_lm(in_indices, num_layers, num_heads, context_length, rope_theta, weights)
