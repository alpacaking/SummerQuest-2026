...
- 代码、日志、图表等其他提交文件：仅在对应正式题面规定的个人作业目录内提交。A1 的
  固定目录和必交文件见 [A1 题面](../assignments/A1/README.md)；A2-P 发布候选稿的
  Profiling 目录、附件大小和禁止文件见
  [A2-P 题面](../assignments/A2-P/README.md)。
...
A1 或 A2-P 将分支名、commit scope 和标题中的编号改为对应的
`a1` / `a2-p` 和 `[A1]` / `[A2-P]`。
